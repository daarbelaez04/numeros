 ...
 * @author david
 */
@WebServlet(name = "numero", urlPatterns = {"/numero"})
public class numero extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html style=\"background-color:#2b2b2a \"  >");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>numeros</title>");            
            out.println("</head>");
            out.println("<body>");
            int numerio=Integer.parseInt(request.getParameter("numero"));
            String letras=convertirLetras(numerio);
            out.println("<p>"+letras);
            out.println("</body>");
            out.println("</html>");
        }
    }
